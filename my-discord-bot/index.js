...
// ====================================================
const VERIFY_ROLE_ID = '123456789012345678';      // 1. ใส่ ID ยศที่จะแจก (เช่น Member)
const LOG_CHANNEL_ID = '987654321098765432';      // 2. ใส่ ID ห้อง ❇️・𝐕𝐞𝐫𝐢𝐟𝐲-𝐥𝐨𝐠
// ====================================================
...
client.on('interactionCreate', async (interaction) => {
    ...
    if (interaction.isChatInputCommand()) {
        ...
        if (interaction.commandName === 'menu') {
            ...
            await interaction.reply({ embeds: [menuEmbed], components: [row], flags: MessageFlags.Ephemeral });
        }
